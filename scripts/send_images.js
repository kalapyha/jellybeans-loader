(function () {
  ...
  const imageDownloader = {
    ...
    //           const url = imageDownloader.extractURLFromStyle(
    ...
    removeCross(url) {
      return url.includes("cross.png") ? false : true;
    },
